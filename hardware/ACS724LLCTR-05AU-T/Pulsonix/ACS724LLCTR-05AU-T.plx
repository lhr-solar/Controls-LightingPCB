...
//15717863/1802200/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS724LLCTR-05AU-T" (originalName "ACS724LLCTR-05AU-T")
	...
	(compDef "ACS724LLCTR-05AU-T" (originalName "ACS724LLCTR-05AU-T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS724LLCTR-05AU-T"))
		...
		(attr "Mouser Part Number" "250-724LLCTR05AUT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS724LLCTR-05AU-T?qs=pUKx8fyJudC3f6AQOezPDA%3D%3D")
		(attr "Manufacturer_Name" "Allegro Microsystems")
		(attr "Manufacturer_Part_Number" "ACS724LLCTR-05AU-T")
		(attr "Description" "High-Accuracy, 5V Isolated Current Sensor with Stray Field Rejection")
		(attr "<Hyperlink>" "https://www.allegromicro.com/~/media/files/datasheets/acs724-datasheet.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ACS724LLCTR-05AU-T.stp")
